...
.factory('productsService', function($q) {
    ...
    function getProducts() {
        return {
            "b.lo": {
                name: 'b.lo',
                img: 'http://livingobjects.com/api/images/253',
                title: 'Analytics Software Suite for Network Management',
                excerpt: '<p>b.lo™ is a modular analytics software platform loaded with extensive Network Operation expertise. It uniquely combines Network Performance Management excellence, with business-oriented capabilities to bring unrivalled value to operators and their end-customers.</p>',
            ...
            "eye.lo": {
                name: 'eye.lo',
                img: 'http://livingobjects.com/api/images/286',
                title: 'Application Visibility and Performance Platform',
                excerpt: '<p>eye.lo™ is a multi-tenant platform that deliver Service Providers with a powerful application-aware management platform, helping them to assure the delivery of WAN connectivity services to their business customers.</p>',
